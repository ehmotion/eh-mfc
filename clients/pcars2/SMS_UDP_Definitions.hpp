...
typedef struct sParticipantsData
{
...
#pragma pack(push)
#pragma pack(1)
typedef struct sParticipantInfo
{
...
typedef struct sParticipantStatsInfo
{
...
}sParticipantStatsInfo;																					// 24

typedef struct sParticipantsStats
{
	sParticipantStatsInfo	sParticipants[UDP_STREAMER_PARTICIPANTS_SUPPORTED]; //768
}sParticipantsStats;

typedef struct sTimeStatsData
{
...
typedef struct sParticipantVehicleNamesData
{
...
typedef struct sVehicleClassNamesData
{
